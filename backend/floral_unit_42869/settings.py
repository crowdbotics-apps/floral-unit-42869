"""
Django settings for floral_unit_42869 project.
...
ROOT_URLCONF = 'floral_unit_42869.urls'
...
WSGI_APPLICATION = 'floral_unit_42869.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "floral_unit_42869 API",
    "DESCRIPTION": "API documentation for floral_unit_42869 App",
    "VERSION": "v1",
}
